...
import { 
 ...
 // Handler for updating bill amount state on input change
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-amber-300 dark:bg-gray-900">
      {/* Center the tip calculator card within the screen */}
      <Card className="w-full max-w-md p-6 bg-violet-200 dark:bg-gray-800 shadow-lg rounded-lg">
        <CardHeader>
